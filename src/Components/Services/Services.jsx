  ...
  return (
    <div style={{marginBottom : "50px"}}>
      ...
      <div className="container d-flex justify-content-center">
        <div className="card-group" style={{ gap: "45px" }}>
          <div
          ...
          >
            <div className="card-body text-center" style={{color: "var(--primary-color)"}}>
              ...
              <div className="card-text">
              Trucks weighing from 1tons to 2 tons. Best for furnitures, and other Meduim weighted items
              </div>
            </div>
            <div className="card-footer text-center">
              <button className="btn btn-primary">Order Now</button>
          ...
          >
            <div className="card-body text-center" style={{color: "var(--primary-color)"}}>
              ...
              <div className="card-text" >
              Trucks weighing from 2tons to 4tons. Can carry industrial tools and heavy weighted goods
              </div>
            </div>
            <div className="card-footer text-center">
              <button className="btn btn-primary">Order Now</button>
          ...
          >
            <div className="card-body text-center" style={{color: "var(--primary-color)"}}>
              ...
              <div className="card-text">
                Trucks weighing from 4tons to 8tons. Can carry industrial tools
                and heavy weighted goods
              </div>
            </div>
            <div className="card-footer text-center">
              <button className="btn btn-primary">Order Now</button>
